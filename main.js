...
// 9.Favorite Number:
let fav_num = 7;
let message2 = 'Here is your favourite number' + fav_num;
...
console.log("==== x ====".repeat(6));
//11.Names:
let names = ['saad', 'saleem', 'ahmed', 'haider', 'raza'];
...
console.log("==== x ====".repeat(6));
// 13.Your own Array:
let transportation = ['motocycle', 'Car', 'car Prado', 'Train'];
for (let i = 0; i < transportation.length; i++) {
    console.log('i would like to own a ' + transportation[i]);
}
console.log("==== x ====".repeat(6));
//14.Guests list:
let guests_list = ['Ali', 'Salman', 'Hamza'];
...
let absent_guests = 'Ali';
let new_guests = 'Junaid';
...
let places = ['Italy', 'Canada', 'America', 'Dubai', 'Germany'];
...
//
//20.own choice array:
let proglanguage = ['Python', 'Javacript', 'C++', 'Typecript', 'SQL'];
...
//
//30.Hello Admin:
let username = ['admin', 'Saad', 'Saleem', 'Ali', 'Raza'];
...
let current_users = ['Saad', 'Saleem', 'Ali', 'Raza', 'Haider'];
let new_users = ['Saad', 'Ayan', 'Zain', 'Daniyal', 'Ali'];
